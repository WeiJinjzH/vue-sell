<template>
    <div>
        <div class="shopcart">
            <div class="content" @click="taggleList">
            ...
            <div class="ball-container">
                <div v-for="ball in balls" :key="ball" v-show="ball.show" transition="drop" class="ball">
            ...
            <div class="shopcart-list" v-show="listShow" transition="fold">
                ...
                <div class="list-content" v-el:list-content>
                    <ul>
                        <li v-for="food in selectFoods" :key="food" class="food border-1px">
